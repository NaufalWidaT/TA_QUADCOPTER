### def camera dijadiin 1 sama deteksi_aruco tapi error soale pembacaan cX dan cY ga dapet duluan
...
def deteksi_aruco(frame, aruco_dict, parameters):
    ...
    while True:
        ...
        if ids is not None and len(ids) > 0:
            ...
            # If no markers detected, print a message and draw it on the frame
...
if __name__ == "__main__":
    ...
    t1 = threading.Thread(target=deteksi_aruco)
    t2 = threading.Thread(target=gerakqc)
