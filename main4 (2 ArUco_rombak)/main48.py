...
######## Gerak Satu Arah
        if cX <= 260 and cX >= 0 and cY <= 260 and cY >= 220:
            print("Bergerak Maju")
            velocity(x,0,0)
        elif cX >= 300 and cX <= 640 and cY <= 260 and cY >= 220:
            print("Bergerak Mundur")
            velocity(x,0,0)
        elif cX <= 300 and cX >= 260 and cY >= 260 and cY <= 480:
            print("Bergerak Kiri")
            velocity(0,y,0)
        elif cX <= 300 and cX >= 260 and cY <= 220 and cY >= 0:
            print("Bergerak Kanan")
            velocity(0,y,0)

        if cX <= 300 and cX >= 260 and cY <= 260 and cY >= 220:
...
########################################## LANDING #####################################################
    ...
    if (cX <= 300 and cX >= 260 and cY <= 260 and cY >= 220 and vehicle.location.global_relative_frame.alt <= 1.4):
        vehicle.mode = VehicleMode("LAND")
