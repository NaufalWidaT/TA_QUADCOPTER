### Yang ke 2, 
### ditemukan titik tengah : (x,y)
### 1m = (2,2) ; 2m = (5,5) ; 
### PARAMETER Y MASIH SALAH SETELAH (#If Aruco jauh dan hanya di 1 sisi)
...
#If Aruco jauh dan hanya di 1 sisi
        elif id == 5 and x <= 40 and x >= 20 and y <= 20 and y >= -5:
            print("ID = ", id, "Terbaca, bergerak mundur")
            velocity(-0.2,0, 0, 1)

        elif id == 5 and x >= -40 and x <= -5 and y <= 20 and y >= -5:
            print("ID = ", id, "Terbaca, bergerak maju")
            velocity(0.2, 0, 0, 1)

        elif id == 5 and x <= 20 and x >= -5 and y >= -40 and y <= 55:
            print("ID = ", id, "Terbaca, bergerak kanan")
            velocity(0, 0.2, 0, 1)

        elif id == 5 and x <= 20 and x >= -5 and y <= 40 and y >= 20:
            print("ID = ", id, "Terbaca, bergerak kiri")
            velocity(0, -0.2, 0, 1)


#If Aruco terbaca dan sudekat posisi kiri bawah
        elif id == 5 and x <= 15 and x >= -5 and y <= 15 and x >= -5 and z<=400 and z>=300:
            print("ID = ", id, "Terbaca dan dekat, bergerak maju kanan dan turun 500")
            velocity(-0.1, -0.1, 0.2, 1)

        elif id == 5 and x <= 10 and x >= 8 and y <= 10 and x >= 8 and z <=300 and z>=200:
            print("ID = ", id, "Terbaca dan dekat, bergerak maju kanan dan turun 300")
            velocity(-0.1, -0.1, 0.2, 1)

        elif id == 5 and x <= 8 and x >= 1 and y <= 8 and x >= 1 and z <=200 and z>=100:
            print("ID = ", id, "Terbaca dan dekat, bergerak maju kanan dan turun 200")
            velocity(-0.1, -0.1, 0.2, 1)

        elif id == 5 and x <= 6 and x >= 2 and y <= 6 and x >= 2 and z <=100 and z>=50:
            print("Diatas ArUco Posisi 1,Landing")
...
# If Aruco terbaca dan sudekat posisi kanan atas
        ...
        elif id == 5 and x >= -10 and x <= -3 and y >= -10 and x <= -3 and z <=300 and z>=200:
            ...
            print("Diatas ArUco Posisi 2,Landing")
            vehicle.mode = VehicleMode("LAND")
            vehicle.close()
            exit(1)
...
# If Aruco terbaca dan sudekat posisi kanan bawah
            ...
            print("Diatas ArUco Posisi 3,Landing")
            vehicle.mode = VehicleMode("LAND")
            vehicle.close()
            exit(1)
...
# If Aruco terbaca dan sudekat posisi kiri atas
            ...
            print("Diatas ArUco Posisi 4,Landing")
            vehicle.mode = VehicleMode("LAND")
            vehicle.close()
            exit(1)

# If Aruco 1m, kurang ke depan
        elif id == 5 and x >= -10 and x <= -2 and y <= 6 and x >= 2 and z <=100 and z>=50:
            print("ID = ", id, "Diatas, jarak 100 cm, bergerak maju")
            velocity(0.1, 0, 0, 1)
        elif id == 5 and x <= 10 and x >= 2 and y <= 6 and x >= 2 and z <=100 and z>=50:
            print("ID = ", id, "Diatas, jarak 100 cm, bergerak mundur")
            velocity(-0.1, 0, 0, 1)
        elif id == 5 and x >= -6 and x <= -2 and y <= 10 and x >= 2 and z <=100 and z>=50:
