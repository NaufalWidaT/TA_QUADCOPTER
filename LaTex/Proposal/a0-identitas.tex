...
\providecommand{\judulid}{Sistem Pendaratan Presisi Otonom Quadcopter Pada Landasan Bergerak Menggunakan ArUco Marker} %Judul Tugas Akhir Bahasa Indonesia
\providecommand{\judulen}{Quadcopter Autonomous Precision Landing System With ArUco Marker On a Moving Platform} %Judul Tugas Akhir Bahasa Inggirs
\providecommand{\penulis}{Naufal Wida Taufiqurrahman} %Nama Lengkap Mahasiswa 
\providecommand{\nim}{20507334017} % NIM
