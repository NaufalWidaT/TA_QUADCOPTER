    ...
    while True:
        ...
        if vehicle.location.global_relative_frame.alt > 1.5:
            ...
            if id == 5 and cz5 <= 450 and cz5 >= 150:
                print("x : ", cx, "y : ", cy, "tinggi: ", vehicle.location.global_relative_frame.alt)

                if cx5 >= 350 and cx5 <= 6405:
        ...
        if vehicle.location.global_relative_frame.alt < 1.5:
            ...
            if id == 18 and cz18 <= 150 and cz18 >= 50:
                ...
                if cx18 >= 130 and cx18 <= 160:
                    print("ID = 18 Terbaca, bergerak mundur 18")
                    velocity(-0.1, 0, 0, 1)
                elif cx18 <= 190 and cx18 >= 160:
        ...
        if marker_corners:
            ...
            for ids, corners, i in zip(marker_IDs, marker_corners, total_markers):
                ...
                if ids == 5:
                    ...
                    cx5 = int((top_left[0] + bottom_right[0]) / 2)
                    cy5 = int((top_left[1] + bottom_right[1]) / 2)
                ...
                if ids == 18:
                    cv2.polylines(
                        frame, [corners.astype(np.int32)], True, (0, 255, 0), 4, cv2.LINE_AA
                    )
                    corners = corners.reshape(4, 2)
                    corners = corners.astype(int)
                    top_right = corners[1].ravel()
                    ...
                    # Nambah titik tengah di ArUco Marker
                    cx18 = int((top_left[0] + bottom_right[0]) / 2)
                    cy18 = int((top_left[1] + bottom_right[1]) / 2)
