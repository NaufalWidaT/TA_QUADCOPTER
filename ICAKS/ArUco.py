...
def gerakqc(cX, cY, distx, disty):
    global aTargetAltitude, frame
    ## Hitung kecepatan
    tm = datetime.datetime.now()
    x = (distx * (1 / 320))/1.5
    y = (disty * (1 / 240))/1.8

    print("speedx:", x, "speedy:", y, "cX:", cX, "cY:", cY, tm)
    print(vehicle.location.global_relative_frame.alt)

    if vehicle.location.global_relative_frame.alt >= 2.5:

######## Gerak Serong
        if cX <= 290 and cX >= 0 and cY >= 260 and cY <= 480:
            print("Bergerak Maju Kiri")
            velocity(x,y,0)
        elif cX <= 290 and cX >= 0 and cY <= 220 and cY >= 0:
            print("Bergerak Maju Kiri")
            velocity(x,y,0)
        elif cX >= 340 and cX <= 640 and cY >= 260 and cY <= 480:
            print("Bergerak Mundur Kiri")
            velocity(x,y,0)
        elif cX >= 340 and cX <= 640  and cY <= 220 and cY >= 0:
            print("Bergerak Mundur Kanan")
            velocity(x,y,0)

######## Gerak Satu Arah
        if cX <= 290 and cX >= 0 and cY <= 260 and cY >= 220:
            print("Bergerak Maju")
            velocity(x,0,0)
        elif cX >= 340 and cX <= 640 and cY <= 260 and cY >= 220:
            print("Bergerak Mundur")
            velocity(x,0,0)
        elif cX <= 340 and cX >= 290 and cY >= 260 and cY <= 480:
            print("Bergerak Kiri")
            velocity(0,y,0)
        elif cX <= 340 and cX >= 260 and cY <= 220 and cY >= 0:
            print("Bergerak Kanan")
            velocity(0,y,0)

        if cX <= 340 and cX >= 290 and cY <= 260 and cY >= 220:
...
######## Gerak Satu Arah
        if cX <= 290 and cX >= 0 and cY <= 260 and cY >= 220:
            print("Bergerak Maju (< 2m)")
            velocity(x/2, 0, 0)
        elif cX >= 340 and cX <= 640 and cY <= 260 and cY >= 220:
            print("Bergerak Mundur (< 2m)")
            velocity(x/2, 0, 0)
        elif cX <= 340 and cX >= 290 and cY >= 260 and cY <= 480:
            print("Bergerak Kiri (< 2m)")
            velocity(0, y/2, 0)
        elif cX <= 340 and cX >= 290 and cY <= 220 and cY >= 0:
            print("Bergerak Kanan (< 2m)")
            velocity(0, y/2, 0)
...
########################################## LANDING #####################################################
    ...
    if (cX <= 400 and cX >= 240 and cY <= 280 and cY >= 200 and vehicle.location.global_relative_frame.alt <= 1.5):
        vehicle.mode = VehicleMode("LAND")
