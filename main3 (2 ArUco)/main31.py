...
def cari_aruco():
    ...
    while True:
        ...
        if id == 5:
            print("x : ", cx5, "y : ", cy5, "ukuran :", ukuran5)
        ...
        if id == 18:
            ...
            if cx18 >= 160 and cx18 <= 640:
                print("ID = 18 Terbaca, bergerak mundur")
            #    velocity(-0.1, 0, 0, 1)
            elif cx18 <= 130 and cx18 >= 0:
                print("ID = 18 Terbaca, bergerak maju")
            #    velocity(0.1, 0, 0, 1)
            elif cy18 <= 210 and cy18 >= 0:
                print("ID = 18 Terbaca, bergerak kanan")
            #    velocity(0, 0.1, 0, 1)
            elif cy18 >= 270 and cy18 <= 480:
                print("ID = 18 Terbaca, bergerak kiri")
            #    velocity(0, -0.1, 0, 1)
...
def kamera_aruco():
    global id, cx5, cx18, cy5, cy18, cz5, cz18, ukuran5, ukuran18
        ...
        if marker_corners:
            ...
            for ids, corners18, i in zip(marker_IDs, marker_corners, total_markers):
                if ids == 18:
                    ...
                    ukuran18 = (((top_left18[0] + top_right18[0] + bottom_left18[0] + bottom_right18[0])/2)
                                + ((top_left18[1] + top_right18[1] + bottom_left18[1] + bottom_right18[1])/2))


                    # Nambah titik tengah di ArUco Marker
                    cx18 = int((top_left18[0] + bottom_right18[0]) / 2)
                    cy18 = int((top_left18[1] + bottom_right18[1]) / 2)
                    cz18 = 0.5 * round(tVec[i][0][2], 2)
